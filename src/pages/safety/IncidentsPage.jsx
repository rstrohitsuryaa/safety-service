...
const EMPTY_FILTERS = { projectId: '', status: '', severity: '', dateFrom: '', dateTo: '' };
...
const IncidentsPage = () => {
  ...
  const fetchIncidents = useCallback(async () => {
    ...
    try {
      ...
      if (appliedFilters.severity)  params.append('severity',  appliedFilters.severity);
      ...
      const res = await API.get(`/api/safety/incidents?${params}`);
  ...
  return (
    <DashboardLayout title="Incidents" onLogout={logout}>
      ...
      <div className="d-flex justify-content-between align-items-center mb-3">
        <h5 className="heading-primary mb-0">
          Safety Incidents <span className="text-muted fw-normal fs-6">({totalElements} total)</span>
        </h5>
        {canWrite && (
        ...
        <Card.Body className="py-2">
          <Row className="g-2 align-items-end">
            ...
            <Col md={2}>
              ...
              <Form.Select size="sm" name="severity" value={filters.severity} onChange={handleFilterChange}>
